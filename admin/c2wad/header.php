        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
         			...
         			<li><a href="sendmail.php"><i class="fa fa-eye"></i>Send Mail To All Users</a></li>
         			<li><a href="mail.php"><i class="fa fa-eye"></i>Send Mail To A User</a></li>
