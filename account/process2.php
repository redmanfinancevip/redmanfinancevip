...
<head>
    ...
    <title>Select Currency | Redman Finance</title>
    ...
    <div class="flex-1 md:ml-64">
        ...
        <header class="bg-cardbg shadow-sm">
            <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <h1 class="text-xl font-semibold text-gray-100">Select Payment Currency</h1>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="card p-6">
                    ...
                    <form action="process3.php" method="post">
                        ...
                        <input type="hidden" value="<?php echo htmlspecialchars($amount); ?>" name="amount" />
                        
                        <div class="mb-6">
                            <label for="currency" class="block mb-2">Select Currency</label>
                            <select name="currency" id="currency" class="form-control" required>
                                <?php 
                                $sql22 = "SELECT * FROM wallet";
                                $result22 = mysqli_query($link,$sql22);
                                if(mysqli_num_rows($result22) > 0){
                                    while($row22 = mysqli_fetch_assoc($result22)) { 
                                ?>
                                    <option value="<?php echo htmlspecialchars($row22['name']); ?>">
                                        <?php echo htmlspecialchars($row22['name']); ?>
                                    </option>
                                <?php } } ?>
                            </select>
                        </div>
